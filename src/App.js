...
const App = () => {
  ...
  const deleteExpense = (expenseId) => {
    if (window.confirm('Are you sure you want to delete this expense?')) {
      ...
      setSelectedBudget({
        ...selectedBudget,
        expenses: selectedBudget.expenses.filter(
          (expense) => expense.id !== expenseId
        ),
      });
    }
  ...
  return (
    <Router>
      <div className={`app-container ${darkMode ? 'dark-mode' : 'light-mode'}`}>
              ...
              <>
                      ...
                      {editingBudget && editingBudget.id === budget.id ? (
                        ...
                        <>
                          ...
                          <div className="budget-details">
                            <span>
                              Total: Rp{budget.amount.toLocaleString()} | Sisa:
                              Rp{calculateRemaining(budget).toLocaleString()}
                            </span>
                          </div>
                          <div className="progress-bar">
                            <div
                              ...
                              style={{
                                width: `${
                                  (1 -
                                    calculateRemaining(budget) / budget.amount) *
                                  100
                                }%`,
                              }}
                            ></div>
                ...
                {selectedBudget && (
                  <div className="card">
                    ...
                    <div className="budget-details">
                      <span>
                        Total: Rp{selectedBudget.amount.toLocaleString()} | Sisa:
                        Rp{calculateRemaining(selectedBudget).toLocaleString()}
                      </span>
                    </div>
                    <div className="progress-bar">
                      <div
                        ...
                        style={{
                          width: `${
                            (1 -
                              calculateRemaining(selectedBudget) /
                    ...
                    <table>
                      ...
                      <tbody>
                        {sortExpenses(selectedBudget.expenses).map(
                          (expense) => (
                            <tr key={expense.id}>
                              {editingExpense &&
        ...
        <footer>
          <p>&copy; 2024 Finansialku. All rights reserved.</p>
          <nav>
